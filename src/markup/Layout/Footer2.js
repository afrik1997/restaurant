						...
						<div className="row">
							<div className="col-md-12">
								<div className="logo-footer">
									<Link to={"./"}><img src={require("./../../images/logo-3.png")} alt="" /> </Link>
								</div>
								...
								<p className="copyright">Copyright © 2021 SaturnCode. all rights reserved.</p>
								<ul className="dlab-social-icon">
									...
									<li><Link className="btn white outline circle mr-1"><i className="fa fa-linkedin"></i></Link></li>
									<li><Link className="btn white outline circle "><i className="fa fa-twitter"></i></Link></li>
								</ul>
							</div>
						</div>
					</div>
